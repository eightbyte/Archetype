/**
 * The outline panel and its tabs (P1-9, P1-11).
 *
 * Four tabs, one of which has anything behind it in Phase 1. The other three are here rather
 * than added later because the tab strip is a layout commitment: a panel that grows a tab strip
 * in Phase 3 is a panel whose every measurement changes in Phase 3. They say which phase they
 * arrive in rather than pretending to be empty.
 *
