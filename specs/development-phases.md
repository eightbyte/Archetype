...
**Status:** Active · **Version:** 1.4 · **Date:** 2026-08-31
...
| 2 | [Manuscript Model & Anchors](phase-2-plan.md) | An anchor survives heavy editing around it; deleted text yields `stale`, never a wrong match | **Built, awaiting acceptance** — § 2 ruled (D21–D24 binding, 2026-08-30); Groups A–D delivered 2026-08-31, both suites green. The manual acceptance run is its § 8 |
