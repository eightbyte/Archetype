...
**Status:** **Phase 3 complete**; **Phase 4 planned** — its § 2 unruled · **Version:** 1.7 · **Date:** 2026-09-04
**Phase:** 4 (LLM Provider Layer & Chat) — planned, not started. Phase 3 (Story Bible) closed on 2026-09-04
**Child documents:**
...
- [`specs/phase-4-plan.md`](phase-4-plan.md) — Phase 4 work items; its § 2 holds the decisions Phase 4 cannot start without (**D30–D34, proposed, not binding**)
...
- `specs/providers.md` — the `LLMProvider` port, the normalised request and result, the stream event vocabulary, and what a provider may **not** be asked to do *(written at `P4-1`, before the code it governs)*
