...
register, both reversals accepted, closing backlog `Q2` and `Q7`. **Group A delivered** (`P3-1` …
`P3-4`) and **Group B delivered** (`P3-6` … `P3-8`; `P3-5` landed early with Group A and still owes
its contract fixture and the client half of its closed list). Groups C and D remain, and § 8's run
has not been attempted.
**Version:** 1.2 · **Date:** 2026-09-02
